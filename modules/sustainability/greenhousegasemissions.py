...
class greenhousegas_emissions(object):
    ...
    def get_NOx_mass(self):
        self.fuel_flow_list=[self.performance.fuel_flow_take_off, self.performance.fuel_flow_nox_climb,self.performance.fuel_flow_nox_descent, self.performance.fuel_flow_landing] #self.performance.fuel_flow_descent
        self.M_fuel_list=[self.performance.fuel_mass_take_off,self.performance.fuel_mass_nox_climb,self.performance.fuel_mass_nox_descent, self.performance.fuel_mass_landing] #self.performance.fuel_mass_take_off
        self.EI_NOx= [29.171*self.fuel_flow_list[i]/2 +3.8626 for i in range(4)]
        self.M_NOx=[self.EI_NOx[i]*self.M_fuel_list[i]/2 for i in range(4)]
        return self.M_NOx
