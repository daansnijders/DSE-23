...
config1_cg_x=cg1.calc_x_cg()
config1_cg_y=cg1.calc_y_cg()
config1_cg_z=cg1.calc_z_cg()
...
config3_cg_x=cg3.calc_x_cg()
config3_cg_y=cg3.calc_y_cg()
config3_cg_z=cg3.calc_z_cg()
...
config2_cg_x=cg2.calc_x_cg()
config2_cg_y=cg2.calc_y_cg()
config2_cg_z=cg2.calc_z_cg()
