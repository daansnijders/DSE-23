...
from modules.main_class2 import config1_cg_x, l_f, config1_cg, l_cabin, config1_class2_OEW, config2_class2_OEW, config2_cg_x, config2_cg, config3_class2_OEW, config3_cg_x, config3_cg
