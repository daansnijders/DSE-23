...
cg_max = [0, 0, 0]
weight_max = [0, 0, 0]
cg_min[0], cg_max[0], weight_max[0] = config1.loading_diagrams()
cg_min[1], cg_max[1], weight_max[1] = config2.loading_diagrams()
cg_min[2], cg_max[2], weight_max[2] = config3.loading_diagrams()
