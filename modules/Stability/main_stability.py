...
CL_a_h    = 3.82                                                                # [-] CL_alpha_h
CL_a_ah   = 4.90                                                                # [-] CL_alpha_(A-h)
de_da     = 0.3835                                                              # [-] downwash
...
a_0       = 1                                                                   # [rad] zero lift angle of attack
i_h       = 0                                                                   # [rad] incidence angle htail
i_c       = 0                                                                   # [rad] incidence angle canard
CN_h_a    = 0.5                                                                 # [-] C_N_h_alpha htail
CN_w_a    = 0.5                                                                 # [-] C_N_w_alpha main wing
...
# initialize class:
empennage1 = empennage(1, x_ac, CL_a_h, CL_a_ah, de_da,  l_h[0], S, c, Vh_V, x_le_MAC[0], Cm_ac, CL_ah, x_cg, CL_h, CL_c, CL_a_c, a_0, i_h, i_c, CN_h_a, CN_w_a, CN_c_a, CN_h_def, Vc_V, x_cg_wing)
