...
def get_climb_optimization(mass_climb_initial, thrust_max, CD_climb, S, g, H_m, V_cruise):
    from modules.performance.class2_performance_defs import get_2d_rate_of_climb, get_rate_of_climb, get_fuel_consumption, get_energy_height
