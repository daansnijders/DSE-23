...
class Performance:
    ...
    def analyze_take_off_performance(self):
        ...
        plt.axhline(y=self.OEW + self.fuel_mass, linestyle=':')
        plt.text(2000, self.OEW + self.fuel_mass, 'OEW+M_fuel')
    ...
    def analyze_fuel_consumption(self):
        ...
        'climb_2'
        fuel_flow_climb_2, fuel_mass_climb_2, climb_2_final_velocity, distance_2 = \
