def serviceable_airports(altitude_length_list, airport_altitude_list, flying_range, show_airport_plots):
    import pandas as pd
    import numpy as np
    ...
    if show_airport_plots:
        ...
        Filtering options
        ---
        Select eg for flights in USA, only large airports, etc
        """
        ...
        print('saving you time since 2019')
