...
OEW = [36689.95, 39579.53, 40108.34]                                            # [kg] operational empty weight
...
CD0, CDcruise, LoverD, Nacelle=drag3(A, S, S_h, S_v, l_nose, l_tailcone, l_f, d_f_outer, d_nacel, l_nacel, lambda_le_rad, CLdes)
