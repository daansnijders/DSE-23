...
x_le_MAC2 = [x_le_MAC[i]+0.1*l_f[i] for i in range(3)]
x_le_MAC3 = [x_le_MAC[i]-0.1*l_f[i] for i in range(3)]

x_cg_wing,x_cg_eng,x_cg_wing_group=get_cg_winggroup(x_le_MAC, MAC,M_wing, M_eng, M_wing_group )
x_cg_wing2,x_cg_eng2,x_cg_wing_group2=get_cg_winggroup(x_le_MAC2, MAC,M_wing, M_eng, M_wing_group )
x_cg_wing3,x_cg_eng3,x_cg_wing_group3=get_cg_winggroup(x_le_MAC3, MAC,M_wing, M_eng, M_wing_group )
