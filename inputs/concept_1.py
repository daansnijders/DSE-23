...
OEW = [34631.92,38223.31,38729.81]#[27745.73, 27069.62, 38729.81]                                            # [-]
MTOW = [58722.6,67394,68264.27] #get_MTOW(OEW)                                                            # [kg]
...
landing_field_length = [get_landing_field_length(thrust_max, MTOW[i], g, h_screen, rho_0, S[i], CLmax[i], CDcruise[i],
                                                 get_friction_coefficient(P_nw[i], MTOW[i], x_mlg[i], x_nlg[i],
