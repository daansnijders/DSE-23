...
for x in xr:
    ...
    if x>=0 and x<0.22:
        y = 5.914 * x**1.2 *(1-x)**2 + 2.316 * x**1.5 * (1-x)**2 + 0.1197 * x**0.5 * (1-x)**0.5
    elif x>=0.22 and x<0.27:
        y = 5.914 * x**1.2 *(1-x)**2 + 2.316 * x**1.5 * (1-x)**2 + 0.1197 * x**0.5 * (1-x)**0.5 + 10.11 * ((x-0.22)/0.45)**2.5 * (1-((x-0.22)/0.45))**2
    elif x>=0.27 and x<0.67:
        y = 5.914 * x**1.2 *(1-x)**2 + 2.316 * x**1.5 * (1-x)**2 + 0.1197 * x**0.5 * (1-x)**0.5 + 10.11 * ((x-0.22)/0.45)**2.5 * (1-((x-0.22)/0.45))**2 + 20.88 * ((x-0.27)/0.50)**2 * (1-((x-0.27)/0.50))**2
    elif x>=0.67 and x<0.77:
        y= 5.914 * x**1.2 *(1-x)**2 + 2.316 * x**1.5 * (1-x)**2 + 0.1197 * x**0.5 * (1-x)**0.5 + 20.88 * ((x-0.27)/0.50)**2 * (1-((x-0.27)/0.50))**2
