...
config1     = Class2_weight(1,N_pax[0],MTOW[0],M_carried_canard_MZF[0],min(M_MZF), loadfactor[0],V_dive[0],M_fuel[0], T_req[2], l_f[0],d_f_inner[0],d_f_outer[0],l_cabin[0],l_h[0],S[0],S_c[0], b[0],b_c[0], S_v[0],S_h[0],Cr_t[0],Cr_t_c[0],lambda_2_rad[0],lambda_h_2_rad[0], lambda_v_2_rad[0],lambda_c_2_rad[0], S_fus[0])     
config2     = Class2_weight(2,N_pax[1],MTOW[1],M_carried_canard_MZF[1],min(M_MZF), loadfactor[1],V_dive[1],M_fuel[1], T_req[2], l_f[1],d_f_inner[1],d_f_outer[1],l_cabin[1],l_h[1],S[1], S_c[1],b[1],b_c[1], S_v[1],S_h[1],Cr_t[1],Cr_t_c[1],lambda_2_rad[1],lambda_h_2_rad[1], lambda_v_2_rad[1],lambda_c_2_rad[1], S_fus[1])
config3     = Class2_weight(3,N_pax[2],MTOW[2],M_carried_canard_MZF[2],min(M_MZF), loadfactor[2],V_dive[2],M_fuel[2], T_req[2], l_f[2],d_f_inner[2],d_f_outer[2],l_cabin[2],l_h[2],S[2],S_h[2], b[2],b_c[2], S_v[2],S_h[2],Cr_t[2],Cr_t_c[2],lambda_2_rad[2],lambda_h_2_rad[2], lambda_v_2_rad[2],lambda_c_2_rad[2], S_fus[2])
