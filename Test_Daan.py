...
cg_min1, cg_max1, weight_max1 = config1.loading_diagrams()
cg_min2, cg_max2, weight_max2 = config2.loading_diagrams()
cg_min3, cg_max3, weight_max3 = config3.loading_diagrams()
