...
# Loading data
#path = sys.argv[1]
path = r"D:\Bibliotheken\Documenten\OneDrive\Stijn\Documenten\TU\3th Year\DSE\DSE-23\Graphing\Moosha.xlsx"
...
ax.bar(y_new, x_new,width = step-2, align = 'center', color = 'darkorange')
